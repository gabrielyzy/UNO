...
const endRound = (winner) => {
    ...
    if (winner === playerHand) roundDom.textContent = 'Você ganhou a rodada!'
    else roundDom.textContent = 'CPU venceu a rodada...'
...
const endGame = () => {
    ...
    if (playerScore > gameOver) {
        loseFX.play()
        gameDom.textContent = 'CPU ganhou o jogo... Jogar de novo?'
    }  
    else {
        winGameFX.play()
        gameDom.textContent = 'Você ganhou o jogo! Jogar de novo?'
    }
